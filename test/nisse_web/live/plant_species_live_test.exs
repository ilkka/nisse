defmodule NisseWeb.PlantSpeciesLiveTest do
  ...
  describe "Index" do
    ...
    test "updates plant_species in listing", %{conn: conn, plant_species: plant_species} do
      ...
      assert index_live
             |> element("#plant_species-#{plant_species.id} a", "Edit")
             |> render_click() =~
               "Edit Plant species"
    ...
    test "deletes plant_species in listing", %{conn: conn, plant_species: plant_species} do
      ...
      assert index_live
             |> element("#plant_species-#{plant_species.id} a", "Delete")
             |> render_click()
  ...
  describe "Show" do
    ...
    test "displays plant_species", %{conn: conn, plant_species: plant_species} do
      {:ok, _show_live, html} =
        live(conn, Routes.plant_species_show_path(conn, :show, plant_species))
